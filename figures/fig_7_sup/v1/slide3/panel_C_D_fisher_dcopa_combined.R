...
RUNS <- list(
  ...
  list(
    dcopa_path    = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7_sup/v1/slide3/panel_C_D_DFC_dcopa_genelist.csv"),
    save_dir      = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7_sup/v1/slide3/"),
    ...
    list(
    dcopa_path    = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7_sup/v1/slide3/panel_C_D_MTG_dcopa_genelist.csv"),
    save_dir      = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7_sup/v1/slide3/"),
    universe_path = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7/v3/all_bulk_genes.txt"),
    file_prefix   = "panel_C_D_MTG"
    # Optional: override axis labels (omit to use set_keys as axis text)
    # axis_label    = c(
    #   "Gabitto + Liu, DFC + MTG"             = "Gabitto + Liu\nDFC + MTG",
    #   "Gabitto + Liu, DFC + MTG (AD modules)" = "Gabitto + Liu, DFC + MTG\n(AD modules)"
