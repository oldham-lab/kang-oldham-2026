...
# Load lists of significant modules shared between datasets
...
plot_copa_compare_summary(euc_dist,
                          plot_title = "Morabito vs SEAAD2024",
                          pos_neg_vec = c("AD", "con"),
                          save_dir=file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_AD/morabito_vs_seaad2024/"))
