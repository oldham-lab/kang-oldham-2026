...
#
# Outputs (in fig_s11/v2, all vector SVG — assemble_figure.py composes the figure):
...
OUT_DIR     <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s11/v2")
