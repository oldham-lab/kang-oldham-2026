# v2
# - same structure but running with optimized DE code
...
version <- "v2"
# Set save dir
save_dir <- file.path(file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_1/"), version)
...
# rm(sn_expr)
# qsave(gene_means_log, file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_1/v1/jorstad_gene_means_log_dfc.qs"))
gene_means_log <- qread(file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_1/v1/jorstad_gene_means_log_dfc.qs"))
...
# gene_means_log <- log(gene_means + 1)
# rm(sn_expr)
# qsave(gene_means_log, file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_1/v1/gabitto_gene_means_log_dfc.qs"))
gene_means_log_sea <- qread(file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_1/v1/gabitto_gene_means_log_dfc.qs"))
