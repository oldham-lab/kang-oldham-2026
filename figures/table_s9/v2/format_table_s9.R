...
# ============================================================
INPUT_CSV <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/table_s9/v2/table_s9.csv")
OUT_PATH  <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/table_s9/v2/Kang_Table_S9_v2.xlsx")
