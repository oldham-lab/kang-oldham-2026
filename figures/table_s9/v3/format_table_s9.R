...
# ============================================================
INPUT_CSV <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/table_s9/v3/table_s9.csv")
OUT_PATH  <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/table_s9/v3/Kang_Table_S9_v3.xlsx")

TITLE <- paste0("Table S9 | Assignments of all genes to all modules identified ",
                "by CoPA in normal human frontal cortex")
...
setColWidths(wb, "table_s9", cols = 1:n_cols, widths = col_widths + 2)
...
# Put Legend first, table_s9 second
