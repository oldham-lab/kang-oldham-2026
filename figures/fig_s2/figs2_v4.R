...
ggsave(p, file = file.path(save_dir,"panel_C_upset_top.pdf"), bg = "white", width = 5, height = 2)
...
sn_anno <- fread(file.path(Sys.getenv("ESSA_DIR", "/home/gugene/code/git/ESSA"), "data/Lein_2023_cell_annotations_DFC.csv"), data.table = FALSE) # OK to use DFC file here
