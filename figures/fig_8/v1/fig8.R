...
fwrite(plotlist_save_create(plotlist[[1]], "CTRL modules | CMC + SZBDMultiseq SN", dcopa_shared_overlaps_save[[1]]),
       file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7/dcopa_dot_data_path/scz_dfc.csv")     
) # DFC ctrl mods
fwrite(plotlist_save_create(plotlist[[1]], "SCZ modules | CMC + SZBDMultiseq SN", dcopa_shared_overlaps_save[[2]]),
       file = file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_7/dcopa_dot_data_path/scz_dfc_sczmods.csv")     
) # DFC SCZ mods
