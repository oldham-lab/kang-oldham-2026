...
# v4: GSEA summary table regenerated by fig8_panelA_bracket.R on HGNC-corrected overlaps
# + rebuilt scz_db (Sonnet-5 literature review). Source the v4 FDR table.
SRC_HTML = f"{V4}/panel_G_gsea_summary_table_dfc_fdr.html"
OUT_HTML = f"{V4}/panel_e_gsea_table.html"
OUT_PDF  = f"{V4}/panel_e_gsea_table.pdf"
