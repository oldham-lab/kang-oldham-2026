...
cell_exprall <- fread(file.path(Sys.getenv("DATA_OTHER_DIR", "/home/gugene/data_other"), "lein_dfc/impute/MAGIC/magic_impute.csv"),data.table=F) %>% t
...
create_donorspecific_pseudobulk(cell_exprall = cell_exprall,
                                ...
                                save_dirall = file.path(Sys.getenv("MEGASET_DIR", "/home/gugene/RNAseq_megaset"), "13.1-sn_cell_pseudobulk/lein2023/DFC_indiv_donor_MAGIC/"),
...
model_donorspecific_pseudobulk(dirlist = c(file.path(Sys.getenv("MEGASET_DIR", "/home/gugene/RNAseq_megaset"), "13.1-sn_cell_pseudobulk/lein2023/DFC_indiv_donor_MAGIC/")),
                               cell_annoall=cell_annoall,
