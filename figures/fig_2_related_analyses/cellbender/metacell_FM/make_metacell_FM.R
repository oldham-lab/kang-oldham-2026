...
qsave(metacell_mat,file=file.path(Sys.getenv("EXTFIG_DIR", "/home/gugene/figures"), "figure_1/cellbender_metacell_FM/gluta_metacell_expr_mat.qs"))
...
WD <- file.path(Sys.getenv("EXTFIG_DIR", "/home/gugene/figures"), "figure_1/cellbender_metacell_FM/metacell_gluta_Modules")
