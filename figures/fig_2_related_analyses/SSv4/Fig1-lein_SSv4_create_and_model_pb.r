...
save_dirall <- file.path(Sys.getenv("MEGASET_DIR", "/home/gugene/RNAseq_megaset"), "13.1-sn_cell_pseudobulk/lein2023/DFC_SSv4_indiv_donor/")
cell_annoall <- fread(file.path(Sys.getenv("DATA_OTHER_DIR", "/home/gugene/data_other"), "lein_dfc_ssv4/lein_dfc_metadata.csv"),data.table=F)
cell_exprall <- qread(file.path(Sys.getenv("DATA_OTHER_DIR", "/home/gugene/data_other"), "lein_dfc_ssv4/lein_dfc_counts.qs"))
...
#CHST5 
# 2138
#qsave(san_mean,file=file.path(Sys.getenv("DATA_OTHER_DIR", "/home/gugene/data_other"), "lein_dfc_ssv4/gene_count_means.qs"))
...
qsave(san_mean_list,file=file.path(Sys.getenv("DATA_OTHER_DIR", "/home/gugene/data_other"), "lein_dfc_ssv4/gene_count_means_byDonor.qs"))
