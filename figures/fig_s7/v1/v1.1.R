...
# Run python script
# /home/gugene/code/git/Consensus-analysis/Code_for_figures/fig_s6/calc_mean_se_per_celltype.py

# Load output files
paths <- c(
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s6/v1/expression_DFC_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s6/v1/expression_MTG_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s6/v1/SEAAD_A9_RNAseq_final-nuclei.2024-02-13_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s6/v1/SEAAD_MTG_RNAseq_final-nuclei.2024-02-13_mean_se.csv")
)
path_names <- c(
...
p <- mats |>
  ...
  ggplot(aes(x = CellType_cap, y = Mean, fill = CellType_cap)) +
    ...
    scale_fill_manual(values = scales::hue_pal()(length(unique(mats$CellType_cap)))) +
...
ggsave(p, file = file.path(save_dir, paste0("panel_1.pdf")), height = 5, width = 5.5)
ggsave(p, file = file.path(save_dir, paste0("panel_1.svg")), height = 5, width = 5.5)
