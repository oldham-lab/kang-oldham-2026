...
# v3: the gene set plotted is the common universe (intersection of all datasets on
# canonical HGNC symbols), computed by build_common_universe.py -> v3/common_genes.txt.
# The per-celltype mean/SE CSVs below are produced by the calc_mean_se_per_celltype_*.py
# scripts restricted to that universe (run_all_calc.sh).

# Load output files
paths <- c(
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/expression_DFC_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/expression_MTG_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/SEAAD_A9_RNAseq_final-nuclei.2024-02-13_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/SEAAD_MTG_RNAseq_final-nuclei.2024-02-13_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/MIT_AD_PFC_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/MIT_AD_MTC_mean_se.csv"),
  file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s7/v3/morabito_2021_mean_se.csv")
)
path_names <- c(
