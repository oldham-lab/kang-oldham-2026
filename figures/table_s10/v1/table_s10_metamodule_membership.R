...
# fig_5/v5/fig_5_v5.R (DFC) and fig_s8/v1.1.R (MTG). Four tabs = 2 datasets
...
#   MTG (fig_s8/v1.1.R): nodes = size>3 + significance set, Mod# = 1..length(final)
...
net_dfc <- "Pearson-no_TO_signum0.704_minSize3_merge_ME_1_1014"
net_mtg <- "Pearson-no_TO_signum0.702_minSize3_merge_ME_1_1014"
paths <- list(
  jorstad_dfc = file.path(f5, "Jorstad_DFC_consensusMin_noMerge_Modules", net_dfc),
  gabitto_dfc = file.path(f5, "Gabitto_DFC_consensusMin_noMerge_Modules", net_dfc),
  jorstad_mtg = file.path(f8, "Jorstad_MTG_consensusMin_noMerge_Modules", net_mtg),
  gabitto_mtg = file.path(f8, "Gabitto_MTG_consensusMin_noMerge_Modules", net_mtg)
)
