...
# fig_s8/v1.1.R: load Module_eigengenes.csv, order Gabitto's meta-modules to match
...
f8 <- file.path(Sys.getenv("REPO_DIR", "/home/gugene/code/git/kang-oldham-2026"), "figures/fig_s8/v1")
paths <- list(
  jorstad_dfc = file.path(f5, "Jorstad_DFC_consensusMin_noMerge_Modules/Pearson-no_TO_signum0.704_minSize3_merge_ME_1_1014/Module_eigengenes.csv"),
  gabitto_dfc = file.path(f5, "Gabitto_DFC_consensusMin_noMerge_Modules/Pearson-no_TO_signum0.704_minSize3_merge_ME_1_1014/Module_eigengenes.csv"),
  jorstad_mtg = file.path(f8, "Jorstad_MTG_consensusMin_noMerge_Modules/Pearson-no_TO_signum0.702_minSize3_merge_ME_1_1014/Module_eigengenes.csv"),
  gabitto_mtg = file.path(f8, "Gabitto_MTG_consensusMin_noMerge_Modules/Pearson-no_TO_signum0.702_minSize3_merge_ME_1_1014/Module_eigengenes.csv")
)
