...
SEA_EXPR_PATH  <- file.path(Sys.getenv("DATA_DIR", "/mnt/bdata/gugene"), "datasets/SN_RNAseq/sea_ad_2024/RNAseq/dfc_data_pseudobulk/sea_dfc_pseudobulk.csv.gz")
SEA_ANNO_PATH  <- file.path(Sys.getenv("DATA_DIR", "/mnt/bdata/gugene"), "datasets/SN_RNAseq/sea_ad_2024/RNAseq/dfc_data_pseudobulk/sea_dfc_pseudobulk_annotations.csv")
...
# --- Output directories ---
MIT_DE_DIR     <- file.path(Sys.getenv("DE_DIR", "/home/gugene/code/git/kang-oldham-2026/figures/fig_7/DE_old"), "MIT_DE_results_new/")
SEA_DE_DIR     <- file.path(Sys.getenv("DE_DIR", "/home/gugene/code/git/kang-oldham-2026/figures/fig_7/DE_old"), "SEA_DE_results_new/")
