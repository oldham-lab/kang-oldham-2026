...
#       --outdir /home/gugene/bdata/@shared/.../MTC/mtc_data_pseudobulk/
#
MIT_PB_EXPR_PATH <- file.path(Sys.getenv("SHARED_DATA_DIR", "/mnt/bdata/@shared"), "scsn.expr_data/human_expr/postnatal/MIT_AD_Multiomic_Multiregion/MTC/mtc_data_pseudobulk/mit_mtc_pseudobulk.csv.gz")
MIT_PB_ANNO_PATH <- file.path(Sys.getenv("SHARED_DATA_DIR", "/mnt/bdata/@shared"), "scsn.expr_data/human_expr/postnatal/MIT_AD_Multiomic_Multiregion/MTC/mtc_data_pseudobulk/mit_mtc_pseudobulk_annotations.csv")

# --- MIT_Multiome column names in annotation file ---
MIT_CELLTYPE_COL <- "RNA.Subclass"    # celltype label column
MIT_DX_COL       <- "Diagnosis"    # diagnosis column
...
SEA_EXPR_PATH  <- file.path(Sys.getenv("DATA_DIR", "/mnt/bdata/gugene"), "datasets/SN_RNAseq/sea_ad_2024/mtg/RNAseq/mtg_data_pseudobulk/sea_mtg_pseudobulk.csv.gz")
SEA_ANNO_PATH  <- file.path(Sys.getenv("DATA_DIR", "/mnt/bdata/gugene"), "datasets/SN_RNAseq/sea_ad_2024/mtg/RNAseq/mtg_data_pseudobulk/sea_mtg_pseudobulk_annotations.csv")
...
# --- Output directories ---
MIT_DE_DIR     <- file.path(Sys.getenv("DE_DIR", "/home/gugene/code/git/kang-oldham-2026/figures/fig_7/DE_old"), "MIT_DE_results_MTG")
SEA_DE_DIR     <- file.path(Sys.getenv("DE_DIR", "/home/gugene/code/git/kang-oldham-2026/figures/fig_7/DE_old"), "SEA_DE_results_MTG")
