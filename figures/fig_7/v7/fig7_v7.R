...
ad_db <- list(
  ...
  # ER stress / ERAD
  EDEM3    = list(n=3,  ref=9),
  ERLEC1   = list(n=3,  ref=9),
  # Stress granules / RNA regulation
  G3BP2    = list(n=3,  ref=10),
  # Tau kinase (JNK pathway)
  MAPK9    = list(n=4,  ref=11),
  # Oxidative stress / neuroprotection
  OXR1     = list(n=3,  ref=12),
  # Tau phosphatase
  PPM1H    = list(n=3,  ref=13),
  PPP2R2B  = list(n=8,  ref=13),
  # ER morphology / APP processing
  RTN1     = list(n=3,  ref=14),
  # COPII / APP ER-to-Golgi trafficking
  SEC23A   = list(n=2,  ref=3),
  # SUMO / tau modification
  SENP1    = list(n=4,  ref=15),
  # Synaptic vesicle exocytosis
  SNAP25   = list(n=5,  ref=16),
  # Cytoskeletal integrity / caspase cleavage
  SPTAN1   = list(n=3,  ref=17),
  # Synaptic phosphoinositide turnover
  SYNJ1    = list(n=9,  ref=18),
  # Mitochondrial protein import
  TOMM70   = list(n=3,  ref=19),
  # Presenilin interactor / APP trafficking
  UBQLN1   = list(n=6,  ref=20),
  # UPS / tau clearance
  USP14    = list(n=6,  ref=21),
  # Ca2+ sensor / AD biomarker
  VSNL1    = list(n=6,  ref=22),
  # Palmitoylation / APP processing
  ZDHHC17  = list(n=3,  ref=23)
)
...
ad_db <- list(
  ...
  # Lysosomal V-ATPase / acidification
  ATP6V1A  = list(n=8,  ref=2),
  ATP6V1C1 = list(n=5,  ref=2),
  # Autophagy / ALS-FTD pathway
  C9orf72  = list(n=4,  ref=3),
  # Calcium channel / signalling
  CACNA2D1 = list(n=3,  ref=4),
  # Tau kinase Cdk5
  CDK5R1   = list(n=10, ref=5),
  # Endocytosis / clathrin
  CLTC     = list(n=7,  ref=6),
  # Ubiquitin-proteasome system
  CUL1     = list(n=3,  ref=7),
  KLHL7    = list(n=2,  ref=7),
  # Clathrin uncoating / endocytic recycling
  DNAJC6   = list(n=3,  ref=8),
  # Mitochondrial fission
  DNM1L    = list(n=8,  ref=9),
  # Axonal transport
  DYNC1LI1 = list(n=6,  ref=10),
  # ER stress / ERAD
  EDEM3    = list(n=3,  ref=11),
  ERLEC1   = list(n=3,  ref=11),
  # Stress granules / RNA regulation
  G3BP2    = list(n=3,  ref=12),
  # Autophagy / LC3-II
  MAP1LC3B = list(n=8,  ref=13),
  # Tau kinase (JNK / p38 MAPK)
  MAPK9    = list(n=4,  ref=14),
  MAPK14   = list(n=5,  ref=14),
  # Neprilysin / Abeta degradation
  MME      = list(n=5,  ref=15),
  # Synaptic adhesion
  NLGN1    = list(n=5,  ref=16),
  # Oxidative stress / neuroprotection
  OXR1     = list(n=3,  ref=17),
  # Endolysosomal PI(3,5)P2 synthesis
  PIKFYVE  = list(n=4,  ref=18),
  # Tau phosphatase
  PPM1H    = list(n=3,  ref=19),
  PPP2R2B  = list(n=8,  ref=19),
  # Mitophagy
  PRKN     = list(n=7,  ref=20),
  # Recycling endosome
  RAB11A   = list(n=8,  ref=21),
  # Late endosome / autophagosome maturation
  RAB7A    = list(n=8,  ref=22),
  # BACE1-APP scaffolding
  RANBP9   = list(n=5,  ref=23),
  # ER morphology / APP processing
  RTN1     = list(n=3,  ref=24),
  RTN3     = list(n=5,  ref=24),
  # Lipid metabolism
  SACM1L   = list(n=2,  ref=25),
  # COPII / APP ER-to-Golgi trafficking
  SEC23A   = list(n=2,  ref=26),
  # Synaptic vesicle exocytosis
  SNAP25   = list(n=5,  ref=27),
  # Synaptic phosphoinositide turnover
  SYNJ1    = list(n=9,  ref=28),
  # Tau kinase (TAOK / MARK cascade)
  TAOK1    = list(n=5,  ref=29),
  # Neuroinflammation / NF-kB
  TBK1     = list(n=4,  ref=30),
  # Lysosomal / TDP-43 pathology
  TMEM106B = list(n=9,  ref=31),
  # Selective autophagy / TLR adaptor
  TOLLIP   = list(n=5,  ref=32),
  # Mitochondrial protein import
  TOMM70   = list(n=3,  ref=33),
  # Presenilin interactor / UPS
  UBQLN1   = list(n=6,  ref=34),
  UBQLN2   = list(n=6,  ref=34),
  # Mitochondria / Abeta interaction
  VDAC1    = list(n=5,  ref=35),
  # Ca2+ sensor / AD biomarker
  VSNL1    = list(n=6,  ref=36),
  # 14-3-3 / phospho-tau interaction
  YWHAB    = list(n=5,  ref=37)
)
