...
# Load genelists
dfc_list <- fread(data.table = F, file = file.path(save_dir, "panel_E_DFC_dcopa_genelist.csv"))
mtg_list <- fread(data.table = F, file = file.path(save_dir, "/panel_E_MTG_dcopa_genelist.csv"))
