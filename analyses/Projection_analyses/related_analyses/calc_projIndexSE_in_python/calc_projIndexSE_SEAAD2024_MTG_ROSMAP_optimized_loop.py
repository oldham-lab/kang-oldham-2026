...
runs = [
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_SEAAD2024_AllADVsCon_MTG/"),
        "cc_col_map": {
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_SEAAD2024_earlyVsCon_MTG/"),
        "cc_col_map": {
            "source_col": "Overall AD neuropathological Change",
            "mapping": {
                "Not AD": "Con",
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_SEAAD2024_lateVsEarly_MTG/"),
        "cc_col_map": {
            "source_col": "Overall AD neuropathological Change",
            "mapping": {
                "High": "Late",
