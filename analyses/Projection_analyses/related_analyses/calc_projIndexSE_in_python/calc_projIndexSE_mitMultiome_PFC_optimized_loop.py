...
runs = [
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/finalNonNorm_minsize10_unmerged/MIT_ADMultiome_AllADVsCon_PFC/"),
        "cc_col_map": {
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/finalNonNorm_minsize10_unmerged/MIT_ADMultiome_earlyVsCon_PFC/"),
        "cc_col_map": {
            "source_col": "Pathology",
            "mapping": {
                "nonAD": "Con",
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/finalNonNorm_minsize10_unmerged/MIT_ADMultiome_lateVsEarly_PFC/"),
        "cc_col_map": {
            "source_col": "Pathology",
            "mapping": {
                "lateAD": "Late",
