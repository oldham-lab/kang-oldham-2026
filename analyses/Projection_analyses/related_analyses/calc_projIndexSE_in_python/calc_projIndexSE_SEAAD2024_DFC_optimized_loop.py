...
runs = [
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/finalNonNorm_minsize10_unmerged/SEAAD2024_earlyVsCon_DFC/"),
        "cc_col_map": {
            "source_col": "Overall AD neuropathological Change",
            "mapping": {
                "Not AD": "Con",
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/finalNonNorm_minsize10_unmerged/SEAAD2024_lateVsEarly_DFC/"),
        "cc_col_map": {
            "source_col": "Overall AD neuropathological Change",
            "mapping": {
                "High": "Late",
