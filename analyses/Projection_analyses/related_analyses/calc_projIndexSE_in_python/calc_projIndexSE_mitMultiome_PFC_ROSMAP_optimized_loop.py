...
runs = [
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_MITMultiome_AllADVsCon_DFC"),
        "cc_col_map": {
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_MITMultiome_earlyVsCon_DFC"),
        "cc_col_map": {
            "source_col": "Pathology",
            "mapping": {
                "nonAD": "Con",
    ...
    },
    {
        ...
        "out_dir": os.path.join(os.environ.get("DATA_DIR", "/mnt/bdata/gugene"), "data/greedy_march_pipeline_output/rosmap_AD/rosmap_AD_MITMultiome_lateVsEarly_DFC"),
        "cc_col_map": {
            "source_col": "Pathology",
            "mapping": {
                "lateAD": "Late",
