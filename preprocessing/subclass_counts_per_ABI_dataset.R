...
bsif10x <- fread(data.table=F,file.path(Sys.getenv("SHARED_DIR", "/home/shared"), "scsn.expr_data/human_expr/postnatal/bakken_2019/10x/NeMO/author_barcode_annotations_10x.csv"))
...
bsifv4 <- fread(data.table=F,file.path(Sys.getenv("SHARED_DIR", "/home/shared"), "scsn.expr_data/human_expr/postnatal/bakken_2019/SSv4/NeMO/author_barcode_annotations_SSv4.csv"))
...
# Load Lein sif
leinsiflist <- list.files(file.path(Sys.getenv("SHARED_DIR", "/home/shared"), "scsn.expr_data/human_expr/postnatal/jorstad_2023_PMID_37824655/10x/"),full.names=T)
...
leinsifreg <- list.files(file.path(Sys.getenv("SHARED_DIR", "/home/shared"), "scsn.expr_data/human_expr/postnatal/jorstad_2023_PMID_37824655/10x/"),full.names=F)
...
fwrite(outdf,file=file.path(Sys.getenv("HOME_DATA_DIR", "/home/gugene/data"), "cell_counts_by_subclass_ABI_cortex_SN.csv"))
