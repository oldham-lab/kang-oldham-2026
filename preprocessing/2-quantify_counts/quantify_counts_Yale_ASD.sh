...
cd ${DATA_DIR:-/mnt/bdata/gugene}/datasets/RNAseq/PsychENCODE/RNAseq/UCLA_ASD/
ref="${BBMAP_DIR:-/home/gugene/bin/bbmap/bbmap}/resources/adapters.fa"
outdir="${DATA_DIR:-/mnt/bdata/gugene}/datasets/RNAseq/PsychENCODE/RNAseq/UCLA_ASD/trimmed"
