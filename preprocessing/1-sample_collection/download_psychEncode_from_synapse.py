...
# of note:
# - Brainspan data is also hosted here but we already downloaded from SRA
# - CMC fastq data is hosted under Capstone Collection, but we will used Salmon-processed data from CMC portal
...
# Capstone metadata
files = synapseutils.syncFromSynapse(syn, 'syn22416880', path = 'metadata/Capstone/')
# CMC scrnaSeq metadata
files = synapseutils.syncFromSynapse(syn, 'syn22331712', path = 'metadata/CMC/')
# Yale-ASD
files = synapseutils.syncFromSynapse(syn, 'syn4566330', path = 'metadata/Yale_ASD/')
files = synapseutils.syncFromSynapse(syn, 'syn11227080', path = 'RNAseq/Yale_ASD/')
# BipSeq DLPFC
files = synapseutils.syncFromSynapse(syn, 'syn8408214', path = 'RNAseq/BipSeq/')
...
files = synapseutils.syncFromSynapse(syn, 'syn11038293', path = 'RNAseq/UCLA_ASD/')
